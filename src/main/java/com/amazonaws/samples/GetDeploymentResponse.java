...
public class GetDeploymentResponse {
	...
	private String CompletedAt;                                    // Datatypes needs to be changed to TimeStamp            
	...
	private String EventLog;                                        //Datatypes needs to be changed
	private int FinalBakeTimeInMinutes;
	private float  GrowthFactor;
	private String GrowthType;
	private float PercentageComplete;
	private String StartedAt;                                       //Datatypes need to be changed
